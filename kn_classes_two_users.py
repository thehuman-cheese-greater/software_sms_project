...
class Student(User): # student will inherit from user
    ...
    def student_login_details(): # Student login details (hashed value)
        student_dict = {"username1" : b'$2b$12$kIUFejZkuGMdv3W1mSTKVu744oU138BIHCsRVughAtoZUEfVS/G36', 
                        ...
                        "ID1" : 2,
                        "username2" : b'$2b$12$t/tgzjvkHp4pHJKsTFwzH.gF4WiYZA.mtfA.oqCsfoMvkwLZtPCvq',
                        "password2" : b'$2b$12$t/tgzjvkHp4pHJKsTFwzH.BGSSFja4PA7An287UmteCGYgJnYp/Pe',
                        "ID2" : 1}
        return student_dict["username1"], student_dict["password1"], student_dict["ID1"], student_dict["username2"], student_dict["password2"], student_dict["ID2"]
