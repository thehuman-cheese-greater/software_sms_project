...
def check_if_admin_or_student():
    ...
    if attempt_counter == attempt_lockout: # checking the number of times the user has clicked the button for sign in lockout to occur
        ...
        st_uname_hash_1, st_pdw_hash_1, st_id_1, st_uname_hash_2, st_pdw_hash_2, st_id_2 = classes_sms.Student.student_login_details() #get the values of student login details
        ...
        elif bcrypt.checkpw(a_s_username_bytes, st_uname_hash_1) or bcrypt.checkpw(a_s_username_bytes, st_uname_hash_2): # checking if studnet username was entered
            if bcrypt.checkpw(a_s_password_bytes, st_pdw_hash_1) or bcrypt.checkpw(a_s_password_bytes, st_pdw_hash_2): # checking if student password was entered
                ...
                studentSMS.start(st_id_2, student_name= a_s_username) 
