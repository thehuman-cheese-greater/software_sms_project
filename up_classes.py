...
class Student(User): # student will inherit from user
    ...
    def student_login_details(): # Student login details (hashed value)
        ...
        st_sign_in_uname.setdefault("d_username", []).extend([b'$2b$12$kIUFejZkuGMdv3W1mSTKVu744oU138BIHCsRVughAtoZUEfVS/G36', b'$2b$12$t/tgzjvkHp4pHJKsTFwzH.gF4WiYZA.mtfA.oqCsfoMvkwLZtPCvq'])

        st_sign_in_pdw.setdefault("d_password", []).extend([b'$2b$12$Adf4pnqH/1IYRurvlJHh2OwBh5hn8riOMmCnn7d5Dt3LSeJNyQkRe', b'$2b$12$t/tgzjvkHp4pHJKsTFwzH.BGSSFja4PA7An287UmteCGYgJnYp/Pe'])

        st_sign_in_id.setdefault("d_id", []).append(1)

        return st_sign_in_uname, st_sign_in_pdw, st_sign_in_id

    def student_courses(**student_course_details):
        return dict(**student_course_details)
    

Student.student_login_details()
